 ...
 * dois Marcos entra a inicial do sobrenome, com dois Marcos S. entra o
 * sobrenome por extenso, e com dois Marcos Silva entra o nome inteiro.
 *
 * A inicial do sobrenome já entrou sempre, e saiu. Ela custa três caracteres em
 * cada pastilha, e três caracteres numa coluna que é um sétimo da página é o
 * que decide se dois nomes cabem lado a lado — a folha inteira encolhia para
 * caber um sobrenome que ninguém precisa ler para saber de quem é o plantão.
 * Onde dois primeiros nomes colidem de verdade, o degrau seguinte entra
 * sozinho.
 *
